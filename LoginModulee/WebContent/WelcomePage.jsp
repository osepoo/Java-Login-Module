...
<title>Welcome Page</title>
    ...
    <style>
        ...
        .background {
            background: url('img/bruno.jpg') rgba(0, 0, 0, 0.61);
...
<div class="background"></div>
    <div align = "center" class="pr"><h1>WELCOME</h1></div>
    
    <div align = "center" class="pr"><h1>DON'T ARGUE CORRELATION OVER CAUSATION, JUST BEND THE REALITY YOU SEE TO MATCH THE ONE YOU WANT...WELCOME</h1></div>
